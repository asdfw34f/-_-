...
namespace WindowsFormsApp2
{
    public partial class FormMain : Form
    {
        ...
        private void toolStripMenuItem6_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewГРУППЫСУББОТА.Update();
            dataGridViewЗАЛЫСУББОТА.Update();
            dataGridViewСУББОТА.Update();
            dataGridView10ЗАЛЫПЯТНИЦА.Update();
            dataGridViewГРУППЫПЯТНИЦА.Update();
            dataGridViewПЯТНИЦА.Update();
            dataGridViewГРУППЫЧЕТВЕРГ.Update();
            dataGridViewЗАЛЫЧЕТВЕРГ.Update();
            dataGridViewЧЕТВЕРГ.Update();
            dataGridViewГРУППЫСРЕДА.Update();
            dataGridViewЗАЛЫСРЕДА.Update();
            dataGridViewСРЕДА.Update();
            dataGridViewГРУППЫВТОРНИК.Update();
            dataGridViewВТОРНИК.Update();
            dataGridViewЗАЛЫВТОРНИК.Update();
            dataGridView1ПОНЕДЕЛЬНИК.Update();
            dataGridView2ГРУППЫ.Update();
            dataGridView3ЗАЛЫ_ПОНЕДЕЛЬНИК.Update();
        }
